...
\begin{definition}{ranked tree alphabet}
	\\
...
\end{definition}
\textit{Note: There also exists a definition for tree alphabets that dont have the restriction of arity. These trees are so called \textbf{unranked tree alphabets}, but in this paper we will only take a look at the ranked case.}
