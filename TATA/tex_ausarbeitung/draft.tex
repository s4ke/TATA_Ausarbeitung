...
\addtocmark{Introduction to Ranked Tree Automata} % additional mark in the TOC
%
\chapter*{Introduction}
%

One of the most used standards in the world-wide-web (www) is 
the XML standard or variations of it (HTML, XHTML, etc.). 
\newline \newline
XML

\vspace{1cm}
\begin{flushright}\noindent
June 2014\hfill Martin Braun\\
